...
public class CreditCard {
	...
	public static void main(String[] args) {
		...
		wallet[0] = new CreditCard("John Bowman","California Savings","5391 0375 9387 5909", 5000);
		wallet[1] = new CreditCard("John Bowman","Califonia Federal","3485 0399 3395 1954", 3500);
		wallet[2] = new CreditCard("John Bowman","California Finance","5391 0375 9387 5309", 2500,300);
		wallet[3] = new CreditCard("Jasper Kong","New West Savings","4975 9571 4621 1687", 1000,500);
		
		for (int val = 1; val <=16; val++) {
			wallet[0].charge(4*val);
			...
			if(yesPrint) {
				...
				System.out.println("WARNING!!! EXCEED THE LIMIT . SOTOP USING CREDIT CARD!!!");
			}
		}
