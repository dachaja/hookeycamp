...
public class ImageButton extends Component{
	...
	public void paint(Graphics g) {
		...
		switch (state) {
		case ENABLED:
			offScreen.drawImage(images[ENABLED], 0, 0, 
					rect.width, rect.height, this);
			break;
		case DISABLED:
			offScreen.drawImage(images[DISABLED], 0, 0, 
					rect.width, rect.height, this);
			break;
		case ENTERED:
			offScreen.drawImage(images[ENTERED], 0, 0, 
					rect.width, rect.height, this);
			break;
		case PRESSED:
			offScreen.drawImage(images[PRESSED], 0, 0, 
					rect.width, rect.height, this);
			break;
		}
